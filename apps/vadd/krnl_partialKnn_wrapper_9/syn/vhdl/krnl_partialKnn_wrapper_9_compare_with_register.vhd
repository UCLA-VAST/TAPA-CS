...
entity krnl_partialKnn_wrapper_9_compare_with_register is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_partialKnn_wrapper_9_compare_with_register is 
...
begin
    fcmp_32ns_32ns_1_2_no_dsp_1_U361 : component krnl_partialKnn_wrapper_9_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
