...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("mmap_offset", 64, hls_in, 1, "ap_none", "in_data", 1),
	Port_Property("n", 64, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("stream_din", 33, hls_out, 3, "ap_fifo", "fifo_port_we", 2),
	Port_Property("stream_full_n", 1, hls_in, 3, "ap_fifo", "fifo_status", 2),
	Port_Property("stream_write", 1, hls_out, 3, "ap_fifo", "fifo_data", 2),
};
const char* HLS_Design_Meta::dut_name = "Mmap2Stream";
