...
entity Mmap2Stream_flow_control_loop_pipe_sequential_init is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity Mmap2Stream_flow_control_loop_pipe_sequential_init;

architecture behav of Mmap2Stream_flow_control_loop_pipe_sequential_init is
