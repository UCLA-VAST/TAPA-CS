...
entity krnl_partialKnn_wrapper_3_load is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_partialKnn_wrapper_3_load is 
...
attribute shreg_extract : string;
    ...
    component krnl_partialKnn_wrapper_3_load_Pipeline_VITIS_LOOP_94_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_load_Pipeline_VITIS_LOOP_94_1_fu_54 : component krnl_partialKnn_wrapper_3_load_Pipeline_VITIS_LOOP_94_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
