...
`timescale 1ps/1ps
module krnl_partialKnn_wrapper_8_local_SP_0_A_V_XPM_MEMORY_URAM_1R1W_ram # (
...
endmodule : krnl_partialKnn_wrapper_8_local_SP_0_A_V_XPM_MEMORY_URAM_1R1W_ram
`timescale 1 ns / 1 ps
module krnl_partialKnn_wrapper_8_local_SP_0_A_V_XPM_MEMORY_URAM_1R1W(
    reset,
    clk,
    address0,
    ce0,
...
krnl_partialKnn_wrapper_8_local_SP_0_A_V_XPM_MEMORY_URAM_1R1W_ram krnl_partialKnn_wrapper_8_local_SP_0_A_V_XPM_MEMORY_URAM_1R1W_ram_U(
    .clka( clk ),
    .rsta( reset ),
    .addra( address0 ),
    .ena( ce0 ),
