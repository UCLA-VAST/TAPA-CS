; ModuleID = '/tmp/run-hls-krnl_partialKnn_wrapper_14-c0ss9ahj/project/krnl_partialKnn_wrapper_14/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_krnl_partialKnn_wrapper_14_hw(i65* %searchSpace_0_copy.0, i257* %searchSpace_0_copy.1.0, i257* %searchSpace_0_copy.1.1, i65* %searchSpace_0_copy.2, i257* %searchSpace_0_copy.3, i9* %searchSpace_0_copy.4.0, i9* %searchSpace_0_copy.4.1, i32 %start_id_0, i45* %out_dist_copy, i45* %out_id_copy)
...
declare void @apatb_krnl_partialKnn_wrapper_14_hw(i65*, i257*, i257*, i65*, i257*, i9*, i9*, i32, i45*, i45*)
...
define void @krnl_partialKnn_wrapper_14_hw_stub_wrapper(i65*, i257*, i257*, i65*, i257*, i9*, i9*, i32, i45*, i45*) #7 {
entry:
  ...
  call void @krnl_partialKnn_wrapper_14_hw_stub(%"struct.tapa::async_mmap<ap_uint<256> >"* %10, i32 %7, %"class.tapa::ostream<hls::axis<ap_uint<32>, 0, 0, 0> >"* %11, %"class.tapa::ostream<hls::axis<ap_uint<32>, 0, 0, 0> >"* %12)
...
declare void @krnl_partialKnn_wrapper_14_hw_stub(%"struct.tapa::async_mmap<ap_uint<256> >"*, i32, %"class.tapa::ostream<hls::axis<ap_uint<32>, 0, 0, 0> >"*, %"class.tapa::ostream<hls::axis<ap_uint<32>, 0, 0, 0> >"*)
