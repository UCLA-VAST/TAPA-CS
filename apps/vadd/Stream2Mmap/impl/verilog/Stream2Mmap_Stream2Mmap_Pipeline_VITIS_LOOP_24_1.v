...
module Stream2Mmap_Stream2Mmap_Pipeline_VITIS_LOOP_24_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] trunc_ln145_fu_115_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_52 <= 64'd0;
        end else if (((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln24_fu_94_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln24_reg_136 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        trunc_ln145_reg_145 <= trunc_ln145_fu_115_p1;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln24_fu_94_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln24_reg_136 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln24_reg_136 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln24_reg_136 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        stream_s_read = 1'b1;
    end else begin
        stream_s_read = 1'b0;
    end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln24_reg_136 == 1'd0) & (stream_s_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln24_reg_136 == 1'd0) & (stream_s_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_mmap_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln24_reg_136 == 1'd0) & (stream_s_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_mmap_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((icmp_ln24_reg_136 == 1'd0) & (stream_s_empty_n == 1'b0));
end
...
assign icmp_ln24_fu_94_p2 = ((i_fu_52 == n) ? 1'b1 : 1'b0);
...
assign m_axi_mmap_WDATA = trunc_ln145_reg_145;
...
assign trunc_ln145_fu_115_p1 = stream_s_dout[31:0];

endmodule //Stream2Mmap_Stream2Mmap_Pipeline_VITIS_LOOP_24_1
