...
from tapa.AutoBridge.src.autobridge.Opt.DataflowGraph import Vertex, Edge, DataflowGraph
...
from tapa.AutoBridge.src.autobridge.Floorplan.LegalizeFloorplan import legalize_floorplan
from tapa.AutoBridge.src.autobridge.Floorplan.Utilities import log_resource_utilization
...
def multi_fpga_iterative_bipartition(
  init_v2s: Dict[Vertex, Slot],
  ...
  multi_fpga = len(slot_managers)
  cli_logger.info("multi_iterative_bipartition")
  cli_logger.info(multi_fpga)
  return None