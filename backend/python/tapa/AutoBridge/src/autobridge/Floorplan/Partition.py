...
from tapa.AutoBridge.src.autobridge.Floorplan.EightWayPartition import eight_way_partition
from tapa.AutoBridge.src.autobridge.Floorplan.FourWayPartition import four_way_partition
...
def partition(
  ...
  _logger.info("partition method")
  _logger.info(partition_method)
