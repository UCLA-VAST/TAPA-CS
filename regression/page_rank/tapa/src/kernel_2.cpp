...
void PageRank_2(Pid num_partitions,
...
.invoke(EdgeMem,  "EdgeMem", edge_req[4],  edge_resp[4],  edges[4])
.invoke(EdgeMem,  "EdgeMem", edge_req[5],  edge_resp[5],  edges[5])
.invoke(EdgeMem,  "EdgeMem", edge_req[6],  edge_resp[6],  edges[6])
.invoke(UpdateMem,  "UpdateMem",  update_read_addr[4], update_read_data[4],  update_write_addr[4], update_write_data[4],  updates[4])
.invoke(UpdateMem,  "UpdateMem",  update_read_addr[5], update_read_data[5],  update_write_addr[5], update_write_data[5],  updates[5])
.invoke(UpdateMem,  "UpdateMem",  update_read_addr[6], update_read_data[6],  update_write_addr[6], update_write_data[6],  updates[6])
.invoke(ProcElem,  "ProcElem[4]",  task_req[4],  task_resp[4], vertex_req_r2[0],  vertex_mm2pe_r2[0],  vertex_pe2mm_r2[0], edge_req[4],  edge_resp[4],  update_req[4],  update_mm2pe[4], update_pe2mm[4])
.invoke(ProcElem,  "ProcElem[5]",  task_req[5],  task_resp[5], vertex_req_r2[1],  vertex_mm2pe_r2[1],  vertex_pe2mm_r2[1], edge_req[5],  edge_resp[5],  update_req[5],  update_mm2pe[5], update_pe2mm[5])
.invoke(ProcElem,  "ProcElem[6]",  task_req[6],  task_resp[6], vertex_req_r2[2],  vertex_mm2pe_r2[2],  vertex_pe2mm_r2[2], edge_req[6],  edge_resp[6],  update_req[6],  update_mm2pe[6], update_pe2mm[6])
.invoke(ProcElem,  "ProcElem[7]",  task_req[7],  task_resp[7], vertex_req_r2[3],  vertex_mm2pe_r2[3],  vertex_pe2mm_r2[3], edge_req[7],  edge_resp[7],  update_req[7],  update_mm2pe[7], update_pe2mm[7])
.invoke(UpdateHandler,  "UpdateHandler",  num_partitions, update_config[4],  update_phase[4],  num_updates[4], update_req[4],  update_pe2mm[4],  update_mm2pe[4], update_read_addr[4],  update_read_data[4], update_write_addr[4],  update_write_data[4])
.invoke(UpdateHandler,  "UpdateHandler",  num_partitions, update_config[5],  update_phase[5],  num_updates[5], update_req[5],  update_pe2mm[5],  update_mm2pe[5], update_read_addr[5],  update_read_data[5], update_write_addr[5],  update_write_data[5])
.invoke(UpdateHandler,  "UpdateHandler",  num_partitions, update_config[6],  update_phase[6],  num_updates[6], update_req[6],  update_pe2mm[6],  update_mm2pe[6], update_read_addr[6],  update_read_data[6], update_write_addr[6],  update_write_data[6])
.invoke(UpdateHandler,  "UpdateHandler",  num_partitions, update_config[7],  update_phase[7],  num_updates[7], update_req[7],  update_pe2mm[7],  update_mm2pe[7], update_read_addr[7],  update_read_data[7], update_write_addr[7],  update_write_data[7]);
;
}