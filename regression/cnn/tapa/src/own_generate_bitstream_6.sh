TARGET=hw
TOP=kernel3_1
OUTPUT_DIR="$(pwd)/vitis_run_1_13x6_${TARGET}"
v++ ${DEBUG} \
    ...
    --config /home/ubuntu/tapa_m/regression/cnn/tapa/src/link_config_1_6.ini \
    ...
    --input_files /home/ubuntu/tapa_m/regression/cnn/tapa/src/cnn_1_6.xilinx_u55c_gen3x16_xdma_3_202210_1.hw.xo \
