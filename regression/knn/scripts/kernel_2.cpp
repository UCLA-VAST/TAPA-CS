...
void Knn_2(tapa::ostream<float> &out_board,
...
.invoke( krnl_globalSort_L1_L2,  
    L1_out_dist[0] //input stream,
  L1_out_id[0] //input stream
  ,  L1_out_dist[1] //input
  ,  L1_out_id[1] //input
  ,  L1_out_dist[2], //input
   L1_out_id[2],  //input
   L2_out_dist0,  L2_out_id0 )
.invoke( krnl_globalSort_L1_L2,  L1_out_dist[3],//input
  L1_out_id[3],  //input
  L1_out_dist[4],  L1_out_id[4],  L1_out_dist[5],  L1_out_id[5],  L2_out_dist1,  L2_out_id1 )
;
}