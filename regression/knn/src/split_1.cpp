...
void Mmap2Stream_1(tapa::istream<pkt> &in_board_1, tapa::ostream<pkt> &L2_out_dist1){
...
void Knn(
  ...
  tapa::task()
    ...
    .invoke(Mmap2Stream_1, in_board_1, L2_out_dist1)
    .invoke(Mmap2Stream_2, in_board_2, L2_out_id1)
