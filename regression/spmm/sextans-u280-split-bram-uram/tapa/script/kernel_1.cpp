...
void Sextans_1(tapa::mmap<int> edge_list_ptr,
...
.invoke(read_A, edge_list_ch, fifo_A, NUM_A_LEN, P_N)
...
// .invoke(Scatter_1_2, fifo_A, fifo_A_pe)
.invoke(Scatter_1_2, fifo_A[0], fifo_A_pe[0],  fifo_A_pe[1])
.invoke(Scatter_1_2, fifo_A[1], fifo_A_pe[2],  fifo_A_pe[3])
.invoke(Scatter_1_2, fifo_A[2], fifo_A_pe[4],  fifo_A_pe[5])
.invoke(Scatter_1_2, fifo_A[3], fifo_A_pe[6],  fifo_A_pe[7])
.invoke(Scatter_1_2, fifo_A[4], fifo_A_pe[8],  fifo_A_pe[9])
.invoke(Scatter_1_2, fifo_A[5], fifo_A_pe[10],  fifo_A_pe[11])
.invoke(Scatter_1_2, fifo_A[6], fifo_A_pe[12],  fifo_A_pe[13])
.invoke(read_B, mat_B_ch, fifo_B_pe, K, P_N)
...
.invoke(PEG_Bmtx, PE_inst, fifo_edge_list_ptr, fifo_A_pe, fifo_B_pe, PE_inst, fifo_edge_list_ptr, fifo_B_pe, PE_inst_to_Cmtx, fifo_edge_list_ptr_to_Cmtx, fifo_aBvec)
.invoke(black_hole_int, fifo_edge_list_ptr)
.invoke(PEG_Cmtx, PE_inst_to_Cmtx, fifo_edge_list_ptr_to_Cmtx, fifo_aBvec, fifo_C_pe)
