...
void Sextans_2(const int NUM_ITE,
const int NUM_A_LEN,
const int M,
const int K,
const int P_N,
...
.invoke(black_hole_float_v16,   fifo_B_pe)
.invoke(Merger, fifo_C_pe, fifo_C_ch_result)
...
// .invoke(FloatvMultConst,   beta_u,   fifo_C_read_in,   fifo_C_read_in_beta  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[0],   fifo_C_read_in_beta[0]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[1],   fifo_C_read_in_beta[1]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[2],   fifo_C_read_in_beta[2]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[3],   fifo_C_read_in_beta[3]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[4],   fifo_C_read_in_beta[4]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[5],   fifo_C_read_in_beta[5]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[6],   fifo_C_read_in_beta[6]  )
.invoke(FloatvMultConst,   beta_u,   fifo_C_read_in[7],   fifo_C_read_in_beta[7]  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result,   fifo_C_ch_result_alpha  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result[0],   fifo_C_ch_result_alpha[0]  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result[1],   fifo_C_ch_result_alpha[1]  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result[2],   fifo_C_ch_result_alpha[2]  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result[3],   fifo_C_ch_result_alpha[3]  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result[4],   fifo_C_ch_result_alpha[4]  )
.invoke(FloatvMultConst,   alpha_u,   fifo_C_ch_result[5],   fifo_C_ch_result_alpha[5]  )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha,   fifo_C_read_in_beta,   fifo_C_ch  )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[0],   fifo_C_read_in_beta[0],   fifo_C_ch[0] )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[1],   fifo_C_read_in_beta[1],   fifo_C_ch[1] )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[2],   fifo_C_read_in_beta[2],   fifo_C_ch[2] )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[3],   fifo_C_read_in_beta[3],   fifo_C_ch[3] )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[4],   fifo_C_read_in_beta[4],   fifo_C_ch[4] )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[5],   fifo_C_read_in_beta[5],   fifo_C_ch[5] )
.invoke(FloatvAddFloatv,   fifo_C_ch_result_alpha[6],   fifo_C_read_in_beta[6],   fifo_C_ch[6] )
.invoke(write_C, wrC_inst, fifo_C_ch, mat_C_ch)
