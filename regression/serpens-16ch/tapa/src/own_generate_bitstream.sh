...
v++ ${DEBUG} \
    ...
    --config /home/ubuntu/tapa_m/regression/serpens-16ch/tapa/src/link_config.ini \
    ...
    --input_files /home/ubuntu/tapa_m/regression/serpens-16ch/tapa/src/serpens_1.xilinx_u55c_gen3x16_xdma_3_202210_1.hw.xoo \
    ...
    --advanced.param compiler.userPostSysLinkOverlayTcl=/home/ubuntu/tapa_m/regression/serpens-16ch/tapa/src/post_sys_link.tcl\
    --save-temps \