...
void Serpens(tapa::mmap<int> edge_list_ptr,
    ...
    tapa::task()
        ...
        // .invoke<tapa::join, NUM_CH_SPARSE>(read_A, P_N, NUM_A_LEN, edge_list_ch, fifo_A )
        ...
        .invoke<tapa::join, NUM_CH_SPARSE>(PEG_Xvec, PE_inst, fifo_A, fifo_X_pe, PE_inst, fifo_X_pe, Yvec_inst, fifo_aXvec )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[0], fifo_A[0], fifo_X_pe[0], PE_inst[0], fifo_X_pe[0], Yvec_inst[0], fifo_aXvec[0] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[1], fifo_A[1], fifo_X_pe[1], PE_inst[1], fifo_X_pe[1], Yvec_inst[1], fifo_aXvec[1] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[2], fifo_A[2], fifo_X_pe[2], PE_inst[2], fifo_X_pe[2], Yvec_inst[2], fifo_aXvec[2] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[3], fifo_A[3], fifo_X_pe[3], PE_inst[3], fifo_X_pe[3], Yvec_inst[3], fifo_aXvec[3] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[4], fifo_A[4], fifo_X_pe[4], PE_inst[4], fifo_X_pe[4], Yvec_inst[4], fifo_aXvec[4] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[5], fifo_A[5], fifo_X_pe[5], PE_inst[5], fifo_X_pe[5], Yvec_inst[5], fifo_aXvec[5] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[6], fifo_A[6], fifo_X_pe[6], PE_inst[6], fifo_X_pe[6], Yvec_inst[6], fifo_aXvec[6] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[7], fifo_A[7], fifo_X_pe[7], PE_inst[7], fifo_X_pe[7], Yvec_inst[7], fifo_aXvec[7] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[8], fifo_A[8], fifo_X_pe[8], PE_inst[8], fifo_X_pe[8], Yvec_inst[8], fifo_aXvec[8] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[9], fifo_A[9], fifo_X_pe[9], PE_inst[9], fifo_X_pe[9], Yvec_inst[9], fifo_aXvec[9] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[10], fifo_A[10], fifo_X_pe[10], PE_inst[10], fifo_X_pe[10], Yvec_inst[10], fifo_aXvec[10] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[11], fifo_A[11], fifo_X_pe[11], PE_inst[11], fifo_X_pe[11], Yvec_inst[11], fifo_aXvec[11] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[12], fifo_A[12], fifo_X_pe[12], PE_inst[12], fifo_X_pe[12], Yvec_inst[12], fifo_aXvec[12] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[13], fifo_A[13], fifo_X_pe[13], PE_inst[13], fifo_X_pe[13], Yvec_inst[13], fifo_aXvec[13] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[14], fifo_A[14], fifo_X_pe[14], PE_inst[14], fifo_X_pe[14], Yvec_inst[14], fifo_aXvec[14] )
        // .invoke<tapa::join>(PEG_Xvec, PE_inst[15], fifo_A[15], fifo_X_pe[15], PE_inst[15], fifo_X_pe[15], Yvec_inst[15], fifo_aXvec[15] )
            .invoke<tapa::detach>(black_hole_int, PE_inst)
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[0])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[1])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[2])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[3])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[4])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[5])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[6])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[7])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[8])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[9])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[10])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[11])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[12])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[13])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[14])
        // .invoke<tapa::detach>(black_hole_int,  PE_inst[15])

        .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe)   
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[0])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[1])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[2])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[3])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[4])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[5])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[6])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[7])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[8])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[9])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[10])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[11])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[12])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[13])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[14])
        // .invoke<tapa::detach>(black_hole_float_v16,  fifo_X_pe[15])    
        // .invoke<tapa::join, NUM_CH_SPARSE>(PEG_Yvec, Yvec_inst, fifo_aXvec, fifo_Y_pe )
