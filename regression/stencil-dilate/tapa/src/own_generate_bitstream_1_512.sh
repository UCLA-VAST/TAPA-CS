TARGET=hw
TOP=unikernel
OUTPUT_DIR="$(pwd)/vitis_run_1_512_${TARGET}"
v++ ${DEBUG} \
    ...
    --input_files /home/ubuntu/tapa_m/regression/stencil-dilate/tapa/src/unikernel_1_512.xilinx_u55c_gen3x16_xdma_3_202210_1.hw.xo \
