TARGET=hw
TOP=unikernel_2
OUTPUT_DIR="$(pwd)/vitis_run_2_${TARGET}"
v++ ${DEBUG} \
    ...
    --config /home/ubuntu/tapa_m/regression/stencil-dilate/tapa/src/kernel_2.ini \
    ...
    --input_files /home/ubuntu/tapa_m/regression/stencil-dilate/tapa/src/unikernel_2.xilinx_u55c_gen3x16_xdma_3_202210_1.hw.xo \
